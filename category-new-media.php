...
<div class="clearfix"></div>
<?php if(isset($epv_options['feature-article']) || isset($epv_options['feature-article-vi'])): ?>
...
<?php if(isset($epv_options['pressrelease-post']) || isset($epv_options['pressrelease-post-vi'])): ?>
